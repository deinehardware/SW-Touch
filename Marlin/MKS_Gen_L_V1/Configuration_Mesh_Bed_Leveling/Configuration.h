...
#define STRING_CONFIG_H_AUTHOR "MiniFactory.eu" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sidewinder X1 - Genius"
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.  // Switched to true for BABYSTEPPING
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.12, 80.12, 399.78, 451.13 }
