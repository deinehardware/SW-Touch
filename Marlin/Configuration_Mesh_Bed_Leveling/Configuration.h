...
#define STRING_CONFIG_H_AUTHOR "JeromeJoest - MiniFactory.eu" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 63.13
  #define DEFAULT_bedKi 12.04
  #define DEFAULT_bedKd 220.65
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 444.46 }
